...
class TestFatturaPAXMLValidation(FatturaPACommon):
    ...
    def test_1_di_xml_export(self):
        ...
        with open("/tmp/1.xml", "wt") as o:
            o.write(xml_content.decode())
